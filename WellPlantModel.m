function [xk,zk] = WellPlantModel(dx0,z0,u0,par)
    %    WellModel - Simulates the well network 
    %
    % Inputs:
    %    dx0 = initial differential states
    %    z0 = initial algebraic states
    %    u0 = inputs
    %    par = system parameters
    %
    % Outputs:
    %    xk: numerical SS differential states values
    %    zk: numerical SS algebraic states values
    %
    ...
    % February 2018; Last revision: 28-Feb-2018
